...
import dev.walkertx.esv.utils.RetryConfig;
import dev.walkertx.esv.utils.SpeakeasyHTTPClient;
...
public class Esv {
    ...
    public static class Builder {
        ...
        public Builder apiKey(String apiKey) {
            this.sdkConfiguration.securitySource = SecuritySource.of(dev.walkertx.esv.models.components.Security.builder()
              .apiKey(apiKey)
              .build());
            return this;
        }
        ...
        Builder _hooks(dev.walkertx.esv.utils.Hooks hooks) {
            sdkConfiguration.setHooks(hooks);  
            return this;  
        }
        
        // Visible for testing, may be accessed via reflection in tests
        Builder _hooks(Consumer<? super dev.walkertx.esv.utils.Hooks> consumer) {
