package io.github.walker_tx.esv.hooks;
...
public final class SDKHooks {
    ...
    public static void initialize(io.github.walker_tx.esv.utils.Hooks hooks) {
    ...
    public static void initialize(io.github.walker_tx.esv.utils.AsyncHooks asyncHooks) {
        ...
        // asyncHooks.registerAfterError(io.github.walker_tx.esv.utils.HookAdapters.adapt(mySyncHook));
