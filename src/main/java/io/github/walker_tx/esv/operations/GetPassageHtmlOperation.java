...
public class GetPassageHtmlOperation implements RequestOperation<GetPassageHtmlRequest, GetPassageHtmlResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetPassageHtmlOperation(SDKConfiguration sdkConfiguration) {
