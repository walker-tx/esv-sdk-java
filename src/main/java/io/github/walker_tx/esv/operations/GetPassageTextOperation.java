...
public class GetPassageTextOperation implements RequestOperation<GetPassageTextRequest, GetPassageTextResponse> {
    
    private final SDKConfiguration sdkConfiguration;

    public GetPassageTextOperation(SDKConfiguration sdkConfiguration) {
