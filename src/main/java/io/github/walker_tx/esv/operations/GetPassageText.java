...
public class GetPassageText {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetPassageTextRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPassageTextRequest.class);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPassageTextRequest, io.github.walker_tx.esv.models.operations.async.GetPassageTextResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetPassageTextRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPassageTextRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPassageTextRequest request) {
        ...
        @Override
        public CompletableFuture<io.github.walker_tx.esv.models.operations.async.GetPassageTextResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.github.walker_tx.esv.models.operations.async.GetPassageTextResponse.Builder resBuilder =
                    io.github.walker_tx.esv.models.operations.async.GetPassageTextResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.github.walker_tx.esv.models.operations.async.GetPassageTextResponse res = resBuilder.build();
